task("get-collateral", "Get collateral by miner id")
	...
	.setAction(async (taskArgs) => {
		...
		try {
			...
			const slashing = await storageProviderCollateral.slashings(minerOwnerId);

			console.log("Available collateral: ", ethers.utils.formatEther(available), " FIL");
			console.log("Locked collateral: ", ethers.utils.formatEther(locked), " FIL");
			console.log("Slashed collateral: ", ethers.utils.formatEther(slashing), " FIL");
		} catch (e) {
			console.log(e);
		}
	});
